    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="text-right">
          <div className="font-serif text-lg font-bold text-coffee-espresso">1:{ratio}</div>
            ...
            <div className="space-y-1">
              {poursWithCumulative.map((pour, index) => (
                <div key={pour.id} className="flex items-center gap-2 relative">
                  {/* Timeline dot */}
                  <div className={`relative z-10 w-4 h-4 rounded-full flex-shrink-0 ${pour.isBloom ? 'bg-gradient-accent shadow-md' : 'bg-coffee-espresso'}`} />
